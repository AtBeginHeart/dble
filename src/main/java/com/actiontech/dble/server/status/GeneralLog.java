...
public final class GeneralLog {
    ...
    private volatile int generalLogFileSize;
    private volatile int generalLogQueueSize;
    private volatile int generalLogBufferSize;
    ...
    private GeneralLog() {
        ...
        this.generalLogBufferSize = SystemConfig.getInstance().getGeneralLogBufferSize();
    }
    ...
    public int getGeneralLogBufferSize() {
        return generalLogBufferSize;
    }
