...
import com.actiontech.dble.log.general.LogEntry;
...
public class RotateLogStore {
    ...
    public LogFileManager createFileManager(String name, long maxFileSize, int byteBufferSize) throws IOException {
        File file;
        ...
        return new LogFileManager(name, maxFileSize, raf, currentSize, byteBufferSize, initialTime, initFileExists);
    }

    public class LogFileManager {
        private volatile String fileName;
        private long maxFileSize = 16 * 1024 * 1024;
        ...
        public LogFileManager(String fileName, long maxFileSize, RandomAccessFile raf, long size, int byteBufferSize, long initialTime, boolean initFileExists) {
            ...
            this.byteBuffer = ByteBuffer.wrap(new byte[byteBufferSize]);
