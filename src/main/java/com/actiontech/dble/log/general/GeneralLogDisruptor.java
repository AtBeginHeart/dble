...
public class GeneralLogDisruptor {
    ...
    public void start() {
        ...
        this.disruptor.handleEventsWith(new GeneralLogFilePathChangeEventHandler()).handleEventsWith(new GeneralLogEventHandler());
    ...
    public static final class GeneralLogExceptionHandler implements ExceptionHandler {
        ...
        public void handleOnStartException(Throwable throwable) {
            LOGGER.error("Exception during onStart for general log's disruptor");
        }

        @Override
        public void handleOnShutdownException(Throwable throwable) {
            LOGGER.error("Exception during onShutdown for general log's disruptor");
        }
    }
