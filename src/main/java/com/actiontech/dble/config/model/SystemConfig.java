...
public final class SystemConfig {
    ...
    private int generalLogBufferSize = 4096;
    ...
    public void setGeneralLogBufferSize(int generalLogBufferSize) {
        if (generalLogBufferSize > this.generalLogBufferSize) {
            this.generalLogBufferSize = generalLogBufferSize;
        }
    }
